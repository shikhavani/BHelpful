...
const myRecipes: RecipesListType = [{ recipeId: 3500346 }];
...
export function Recipe(props: RecipeProps) {
	...
	const { Images, Title, Decs, Time, Rating, Ratings, category } =
		recipeInfo(Id);
					...
					<>
						...
						<div>
							<span
								...
								style={{ width: (Rating / Ratings / 5) * 100 + '%' }}
							></span>
						</div>
					</>
				)}
	...
	return (
		<div
			className={type + ' recipe ' + (Id !== -1 ? category : 'empty')}
			id={Id + ''}
